...
With Maven:
    ...
    <dependency>
      ...
      <artifactId>piraspbay</artifactId>
...
[![Continuous Integration status](https://secure.travis-ci.org/clojurewerkz/piraspbay.png)](http://travis-ci.org/clojurewerkz/piraspbay)
